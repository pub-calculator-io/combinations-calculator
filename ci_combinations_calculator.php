...
Version: 1.0.0
Author: Combinations Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Combinations Calculator by www.calculator.io";

function display_calcio_ci_combinations_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_combinations_calculator', 'display_calcio_ci_combinations_calculator' );